    ...
    include"../includes/connect.php";
         ...
         if(isset ($_POST['add'])){
             ...
             $row=mysqli_fetch_assoc($result);
                ...
                'item_image'=>$row['pro_image'],
                'item_quantity'=>$_POST['Quantity'],
                );
             $_SESSION[$row['product_name']]=$item_array;
             //print_r($item_array);
...
<a href="shoping-cart.php?id={$row['product_id']}" class="flex-c-m stext-101 cl0 size-107 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-r-8 m-b-10">
View Cart
</a>
...
<?php 
  ...
  $result=mysqli_query($con,$query);
  while($row=mysqli_fetch_assoc($result)){ 
    echo "<img src='../images/{$row['pro_image']}' width='300' height='350'>";
  }
...
<input type="text" class="mtext-105 cl2 js-name-detail p-b-14" name="name"
value="<?php  
  $id=$_GET['id'];
  $query="select * from product where product_id =$id"; 
  $result=mysqli_query($con,$query);
 ...
 ?>">
<input type="text" class="mtext-106 cl2" name="price"
value="<?php  
  $id=$_GET['id'];
  $query="select * from product where product_id =$id"; 
  $result=mysqli_query($con,$query);
 ...
 ?>">
<input type="text" class="stext-102 cl3 p-t-23" name="description"
value="<?php  
  $id=$_GET['id'];
  $query="select * from product where product_id =$id"; 
  $result=mysqli_query($con,$query);
...
<input type="submit" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 js-addcart-detail" value="Add to cart" name="add">

<input type="hidden" class="stext-102 cl3 p-t-23" name="admin_image"
 value="<?php  
  $id=$_GET['id'];
  $query="select * from product where product_id =$id"; 
  $result=mysqli_query($con,$query);
...
<img src="images/product-01.jpg<?php?id={$row['product_id']} ?>" alt="IMG-PRODUCT">
...
<div class="slick3 gallery-lb">
<input type="text" class="item-slick3" name="item_image" data-thumb="<?php  
    $id=$_GET['id'];
    $query='select * from product where product_id =$id'; 
  $result=mysqli_query($con,$query);
  while($row=mysqli_fetch_assoc($result)){ 
