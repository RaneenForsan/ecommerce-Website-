...
<button type="submit" value="Proceed to Checkout"
        class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer" name="btnbtn"><a href="Login.php" style="color:#FFF;">Proceed to Checkout</a></button>
