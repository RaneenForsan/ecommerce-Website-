...
echo "<div class='sec-banner bg0 p-t-80 p-b-50'>";
echo "<div class='container'>";
echo "<div class='row'>";
while($row=mysqli_fetch_assoc($result)){
echo "<div class='col-md-6 col-xl-4 p-b-30 m-lr-auto' style='float:left'>";
echo"<div class='block1 wrap-pic-w'>";
echo "<img src='../images/{$row['cat_img']}' width='200' height='200'>";
